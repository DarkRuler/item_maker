...
- then (if you satisfy conditions explained in \***Technical info**\* section, you can convert said csv file into Excel spreadsheet! The process is similiar to first program, and resulting Excel file has frozen first row and column for ease of use, as well as sortable values.
...
### Notes
- You might notice that (unlike pw's guide) this one does not generate summaries or ranks (though you might discuss such in forum thread). This is caused by two things:
